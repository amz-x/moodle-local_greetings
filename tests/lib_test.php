...
class lib_test extends \advanced_testcase {
    ...
    public function test_local_greetings_get_greeting(?string $country, string $langstring) {
        ...
        $userfullname = !empty(fullname($user)) ? fullname($user) : 'user';

        $this->assertSame(get_string($langstring, 'local_greetings', $userfullname), local_greetings_get_greeting($user));
    }
}
